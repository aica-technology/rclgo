module github.com/aica-technology/rclgo/examples/custom_message_package/greeter
...
// this repository.
replace github.com/aica-technology/rclgo v0.0.0 => ../../..

require github.com/aica-technology/rclgo v0.0.0
