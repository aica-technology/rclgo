...
[![Go Reference](https://pkg.go.dev/badge/github.com/aica-technology/rclgo.svg)][docs]
...
rclgo-gen can be installed globally by running
    ...
    go install github.com/aica-technology/rclgo/cmd/rclgo-gen@latest
...
Then run `go mod tidy`. This version of rclgo-gen can be used by running
    ...
    go run github.com/aica-technology/rclgo/cmd/rclgo-gen generate -d msgs --include-go-package-deps ./...
...
[docs]: https://pkg.go.dev/github.com/aica-technology/rclgo/pkg/rclgo
